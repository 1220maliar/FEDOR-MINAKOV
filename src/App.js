...
const news = [
  ...
  { 
    id: 2, 
    title: 'Как федор любит проводить свое свободное время ', 
    category: 'Свободное время',
    image: card2
  },
  { 
    id: 3, 
    title: 'Как федор проводит свою школьные дни вне спорта', 
    category: 'Школьные будни',
    image: card3
  },
  { 
    id: 4, 
    title: 'Как началась жизнь Федора и его формирование', 
    category: 'Детсво ',
    image: card4
  },
  { 
    id: 5, 
    title: 'Cпортиивные успехи Федора и его спортивная жизнь', 
    category: 'Спорт',
    image: card5
  }
];
